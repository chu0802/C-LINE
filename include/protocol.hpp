...
typedef enum{
	UI_NO_OPTION = 0xaa,
	UI_NAME_LEN_LIMIT = 0x10,
	UI_PASSWD_LEN_LIMIT = 0x11,
	UI_REGISTER_REPASSWD_WRONG = 0x12,
	UI_REGISTER_SUCCESS = 0x13,
	UI_LOGIN_SUCCESS = 0x14,

	UI_SEND_MSG_LEN_LIMIT = 0x20,
	UI_SEND_MSG_SUCCESS = 0x21,


	UI_ADD_FRIEND_SUCCESS = 0x50,
	UI_DELETE_FRIEND_SUCCESS = 0x51,
} UI_Err_Status;
...
class Request{
	public:
		...
		int setCheckFriend(string);
		int server_setWatchPersonal(string, string);
